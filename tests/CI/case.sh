...
function ViT_base_patch16_384_ft_in1k_1n8c_dp_fp16o2() {
    ...
    loss=`cat log/workerlog.0 | grep 'passl INFO' |grep '49/2502' | awk -F 'loss: ' '{print $2}' | awk -F ',' '{print $1}'`
    ips=`cat log/workerlog.0 | grep 'passl INFO' |grep 'ips: ' | awk -F 'ips: ' '{print $2}' | awk -F ' images/sec,' '{print $1}'| awk 'NR>1 {print}' | awk '{a+=$1}END{print a/NR}'`
    mem=`cat log/workerlog.0 | grep 'passl INFO' |grep '49/2502' | awk -F 'max mem: ' '{print $2}' | awk -F ' GB,' '{print $1}'`
    loss_base=6.90351
    ips_base=734.92
    mem_base=10.04
    check_result $FUNCNAME ${loss_base} ${loss} ${ips_base} ${ips} ${mem_base} ${mem}
...
function ConvNeXt_base_224_in1k_1n8c_dp_fp32() {
    ...
    loss=`cat log/workerlog.0 | grep 'passl INFO' |grep '50/312' | awk -F 'loss: ' '{print $2}' | awk -F ',' '{print $1}'`
    ips=`cat log/workerlog.0 | grep 'passl INFO' |grep 'ips: ' | awk -F 'ips: ' '{print $2}' | awk -F ' images/sec,' '{print $1}'| awk 'NR>1 {print}' | awk '{a+=$1}END{print a/NR}'`
    mem=`cat log/workerlog.0 | grep 'passl INFO' |grep '50/312' | awk -F 'max mem: ' '{print $2}' | awk -F ' GB,' '{print $1}'`
    loss_base=6.91222
    ips_base=708.5226
    mem_base=18.38
    check_result $FUNCNAME ${loss_base} ${loss} ${ips_base} ${ips} ${mem_base} ${mem}
...
function simsiam_resnet50_pt_in1k_1n8c_dp_fp32() {
    ...
    loss=`cat log/workerlog.0 | grep 'passl INFO' |grep '50/2502' | awk -F 'loss: ' '{print $2}' | awk -F ',' '{print $1}'`
    ips=`cat log/workerlog.0 | grep 'passl INFO' |grep 'ips: ' | awk -F 'ips: ' '{print $2}' | awk -F ' images/sec,' '{print $1}'| awk 'NR>1 {print}' | awk '{a+=$1}END{print a/NR}'`
    mem=`cat log/workerlog.0 | grep 'passl INFO' |grep '50/2502' | awk -F 'max mem: ' '{print $2}' | awk -F ' GB,' '{print $1}'`
    loss_base=-0.32832
    ips_base=1969.93
    mem_base=10.55
    check_result $FUNCNAME ${loss_base} ${loss} ${ips_base} ${ips} ${mem_base} ${mem}
...
function simsiam_resnet50_lp_in1k_1n8c_dp_fp32() {
    ...
    loss=`cat log/workerlog.0 | grep 'passl INFO' |grep '50/313' | awk -F 'loss: ' '{print $2}' | awk -F ',' '{print $1}'`
    ips=`cat log/workerlog.0 | grep 'passl INFO' |grep 'ips: ' | awk -F 'ips: ' '{print $2}' | awk -F ' images/sec,' '{print $1}'| awk 'NR>1 {print}' | awk '{a+=$1}END{print a/NR}'`
    mem=`cat log/workerlog.0 | grep 'passl INFO' |grep '50/313' | awk -F 'max mem: ' '{print $2}' | awk -F ' GB,' '{print $1}'`
    loss_base=6.89298
    ips_base=6285.21
    mem_base=5.38
    check_result $FUNCNAME ${loss_base} ${loss} ${ips_base} ${ips} ${mem_base} ${mem}
...
function swav_resnet50_224_ft_in1k_1n4c_dp_fp32() {
    ...
    loss=`cat log/workerlog.0 | grep 'passl INFO' |grep '120/126' | awk -F 'loss: ' '{print $2}' | awk -F ',' '{print $1}'`
    ips=`cat log/workerlog.0 | grep 'passl INFO' |grep 'ips: ' | awk -F 'ips: ' '{print $2}' | awk -F ' images/sec,' '{print $1}'| awk 'NR>1 {print}' | awk '{a+=$1}END{print a/NR}'`
...
function swav_resnet50_224_lp_in1k_1n8c_dp_fp32() {
    ...
    loss=`cat log/workerlog.0 | grep 'passl INFO' |grep '200/5005' | awk -F 'loss: ' '{print $2}' | awk -F ',' '{print $1}'`
    ips=`cat log/workerlog.0 | grep 'passl INFO' |grep 'ips: ' | awk -F 'ips: ' '{print $2}' | awk -F ' images/sec,' '{print $1}'| awk 'NR>1 {print}' | awk '{a+=$1}END{print a/NR}'`
    mem=`cat log/workerlog.0 | grep 'passl INFO' |grep '200/5005' | awk -F 'max mem: ' '{print $2}' | awk -F ' GB,' '{print $1}'`
    loss_base=3.83529
    ips_base=5620.26
    mem_base=0.46
    check_result $FUNCNAME ${loss_base} ${loss} ${ips_base} ${ips} ${mem_base} ${mem}
...
function swav_resnet50_224_pt_in1k_1n8c_dp_fp16o1() {
    ...
    loss=`cat log/workerlog.0 | grep 'passl INFO' |grep '200/2599' | awk -F 'loss: ' '{print $2}' | awk -F ',' '{print $1}'`
    ips=`cat log/workerlog.0 | grep 'passl INFO' |grep 'ips: ' | awk -F 'ips: ' '{print $2}' | awk -F ' images/sec,' '{print $1}'| awk 'NR>1 {print}' | awk '{a+=$1}END{print a/NR}'`
    mem=`cat log/workerlog.0 | grep 'passl INFO' |grep '200/2599' | awk -F 'max mem: ' '{print $2}' | awk -F ' GB,' '{print $1}'`
    loss_base=7.94836
    ips_base=963.2715
    mem_base=8.37
    check_result $FUNCNAME ${loss_base} ${loss} ${ips_base} ${ips} ${mem_base} ${mem}
...
function dino_deit_small_patch16_224_lp_in1k_1n8c_dp_fp16o1() {
    ...
    loss=`cat log/workerlog.0 | grep 'passl INFO' |grep '100/5005' | awk -F 'loss: ' '{print $2}' | awk -F ',' '{print $1}'`
    ips=`cat log/workerlog.0 | grep 'passl INFO' |grep 'ips: ' | awk -F 'ips: ' '{print $2}' | awk -F ' images/sec,' '{print $1}'| awk 'NR>1 {print}' | awk '{a+=$1}END{print a/NR}'`
    mem=`cat log/workerlog.0 | grep 'passl INFO' |grep '100/5005' | awk -F 'max mem: ' '{print $2}' | awk -F ' GB,' '{print $1}'`
    loss_base=6.87702
    ips_base=4847.385
    mem_base=0.30
    check_result $FUNCNAME ${loss_base} ${loss} ${ips_base} ${ips} ${mem_base} ${mem}
...
function dinov2_vit_small_patch14_224_lp_in1k_1n8c_dp_fp16o1() {
    ...
    loss=`cat log/workerlog.0 | grep 'passl INFO' | grep '100/10010' | awk -F 'loss: ' '{print $2}' | awk -F ',' '{print $1}'`
    ips=`cat log/workerlog.0 | grep 'passl INFO' |grep 'ips: ' | awk -F 'ips: ' '{print $2}' | awk -F ' images/sec,' '{print $1}'| awk 'NR>1 {print}' | awk '{a+=$1}END{print a/NR}'`
    mem=`cat log/workerlog.0 | grep 'passl INFO' |grep '100/10010' | awk -F 'max mem: ' '{print $2}' | awk -F ' GB,' '{print $1}'`
    loss_base=6.86828
    ips_base=3950.49
    mem_base=0.21
    check_result $FUNCNAME ${loss_base} ${loss} ${ips_base} ${ips} ${mem_base} ${mem}
